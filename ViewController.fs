...
type ViewController (handle : IntPtr)  = 
   ...
   member val SolarPanelView = new InputView("Solar Panels", [ 1 .. 7])
   member val GreenhousesView = new InputView("Greenhouses", [1.. 7])
   member val PlotsizeView = new InputView("Acres", [ 10 .. 100 .. 1000])
